...
var Packages = []genmain.Package{
	...
	{Name: "gstreamer-1.0"},
	// {Name: "gstreamer-base-1.0"}, not found?
	{Name: "gst-editing-services-1.0"},
	{Name: "gstreamer-allocators-1.0"},
	{Name: "gstreamer-analytics-1.0"},
	// {Name: "gstreamer-app-1.0"}, not found?
	// {Name: "gstreamer-audio-1.0"}, not found?
	// {Name: "gstreamer-bad-audio-1.0"}, not found?
	// {Name: "gstreamer-bad-base-camerabinsrc-1.0"},
	// {Name: "gstreamer-check-1.0"},
	// {Name: "gstreamer-codecs-1.0"},
