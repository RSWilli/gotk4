...
func UnsafeErrorToGlibNone(err error) unsafe.Pointer {
	panic("UnsafeErrorToGlibNone is not implemented")
}
...
// Take returns a new Go error from a *GError and frees the *GError. The given pointer must be
// non nil, the returned error will also be always non nil
...
func UnsafeErrorFromGlibNone(gerror unsafe.Pointer) error {
	panic("UnsafeErrorFromGlibNone is not implemented")
}

func UnsafeErrorFromGlibBorrow(gerror unsafe.Pointer) error {
	panic("UnsafeErrorFromGlibNone is not implemented")
}
