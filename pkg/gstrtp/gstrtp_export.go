...
//export _gotk4_gstrtp1_RTPBasePayload_ConnectAddExtension
func _gotk4_gstrtp1_RTPBasePayload_ConnectAddExtension(arg0 C.gpointer, arg1 *C.GstRTPHeaderExtension, arg2 C.guintptr) {
	var f func(ext RTPHeaderExtensioner)
	{
		closure := coreglib.ConnectedGeneratedClosure(uintptr(arg2))
		if closure == nil {
...
//export _gotk4_gstrtp1_RTPBasePayload_ConnectClearExtensions
func _gotk4_gstrtp1_RTPBasePayload_ConnectClearExtensions(arg0 C.gpointer, arg1 C.guintptr) {
	var f func()
	{
		closure := coreglib.ConnectedGeneratedClosure(uintptr(arg1))
		if closure == nil {
