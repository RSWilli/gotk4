...
// #cgo pkg-config: gstreamer-sdp-1.0 gstreamer-allocators-1.0
...
// MapInfo: map info array of type depending on map_type.
func (m *MIKEYMessage) MapInfo() []unsafe.Pointer {
	valptr := &m.native.map_info
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
		src := unsafe.Slice((*C.gpointer)(p), len)
		_v = make([]unsafe.Pointer, len)
		for i := 0; i < len; i++ {
...
// Payloads: payload array of MIKEYPayload.
func (m *MIKEYMessage) Payloads() []unsafe.Pointer {
	valptr := &m.native.payloads
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
func (m *MIKEYPayloadKEMAC) Subpayloads() []unsafe.Pointer {
	valptr := &m.native.subpayloads
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
// Params: array of MIKEYPayloadSPParam.
func (m *MIKEYPayloadSP) Params() []unsafe.Pointer {
	valptr := &m.native.params
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
// Fmts: array of #gchar formats.
func (s *SDPMedia) Fmts() []unsafe.Pointer {
	valptr := &s.native.fmts
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
// Connections: array of SDPConnection with media connection information.
func (s *SDPMedia) Connections() []unsafe.Pointer {
	valptr := &s.native.connections
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
// Bandwidths: array of SDPBandwidth with media bandwidth information.
func (s *SDPMedia) Bandwidths() []unsafe.Pointer {
	valptr := &s.native.bandwidths
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
// Attributes: array of SDPAttribute with the additional media attributes.
func (s *SDPMedia) Attributes() []unsafe.Pointer {
	valptr := &s.native.attributes
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
func (s *SDPMessage) Emails() []unsafe.Pointer {
	valptr := &s.native.emails
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
func (s *SDPMessage) Phones() []unsafe.Pointer {
	valptr := &s.native.phones
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
func (s *SDPMessage) Bandwidths() []unsafe.Pointer {
	valptr := &s.native.bandwidths
	var _v []unsafe.Pointer // out
	{
		var len uintptr
...
func (s *SDPMessage) Times() []unsafe.Pointer {
	valptr := &s.native.times
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
func (s *SDPMessage) Zones() []unsafe.Pointer {
	valptr := &s.native.zones
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
func (s *SDPMessage) Attributes() []unsafe.Pointer {
	valptr := &s.native.attributes
	var _v []unsafe.Pointer // out
	{
		var len uintptr
...
func (s *SDPMessage) Medias() []unsafe.Pointer {
	valptr := &s.native.medias
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
...
func (s *SDPTime) Repeat() []unsafe.Pointer {
	valptr := &s.native.repeat
	var _v []unsafe.Pointer // out
	{
		var len uintptr
		p := C.g_array_steal(&*valptr, (*C.gsize)(&len))
