...
// #cgo pkg-config: gstreamer-play-1.0 gstreamer-analytics-1.0
...
// PlayMessageParseBufferingPercent: parse the given buffering-percent msg and
...
// PlayMessageParseDurationUpdated: parse the given duration msg and extract the
...
// PlayMessageParseMediaInfoUpdated: parse the given msg and extract the
...
// PlayMessageParseMutedChanged: parse the given msg and extract the
// corresponding audio muted state.
//
// The function takes the following parameters:
//
//   - msg: Message.
...
// PlayMessageParsePositionUpdated: parse the given position msg and extract the
// corresponding ClockTime.
//
// The function takes the following parameters:
//
...
// PlayMessageParseStateChanged: parse the given state msg and extract the
// corresponding PlayState.
//
// The function takes the following parameters:
//
//   - msg: Message.
...
// PlayMessageParseVideoDimensionsChanged: parse the given msg and extract the
// corresponding video dimensions.
//
// The function takes the following parameters:
//
//   - msg: Message.
...
// PlayMessageParseVolumeChanged: parse the given msg and extract the
// corresponding audio volume.
//
// The function takes the following parameters:
//
//   - msg: Message.
...
// PlayMessageParseWarning: parse the given error msg and extract the
// corresponding #GError warning.
//
// The function takes the following parameters:
//
//   - msg: Message.
...
func NewPlay(videoRenderer PlayVideoRendererer) *Play {
	...
	if videoRenderer != nil {
		_arg1 = (*C.GstPlayVideoRenderer)(unsafe.Pointer(coreglib.InternObject(videoRenderer).Native()))
...
func (play *Play) AudioVideoOffset() int64 {
	...
	_arg0 = (*C.GstPlay)(unsafe.Pointer(coreglib.InternObject(play).Native()))
...
func PlayGetAudioStreams(info *PlayMediaInfo) []*PlayAudioInfo {
	...
	_arg1 = (*C.GstPlayMediaInfo)(unsafe.Pointer(coreglib.InternObject(info).Native()))
...
func (info *PlayAudioInfo) Bitrate() int {
	...
	_arg0 = (*C.GstPlayAudioInfo)(unsafe.Pointer(coreglib.InternObject(info).Native()))
...
func (info *PlayMediaInfo) AudioStreams() []*PlayAudioInfo {
	...
	_arg0 = (*C.GstPlayMediaInfo)(unsafe.Pointer(coreglib.InternObject(info).Native()))
...
func NewPlaySignalAdapter(play *Play) *PlaySignalAdapter {
	...
	_arg1 = (*C.GstPlay)(unsafe.Pointer(coreglib.InternObject(play).Native()))
...
func (adapter *PlaySignalAdapter) Play() *Play {
	...
	_arg0 = (*C.GstPlaySignalAdapter)(unsafe.Pointer(coreglib.InternObject(adapter).Native()))
...
func (info *PlayStreamInfo) Caps() *gst.Caps {
	...
	_arg0 = (*C.GstPlayStreamInfo)(unsafe.Pointer(coreglib.InternObject(info).Native()))
...
func (info *PlaySubtitleInfo) Language() string {
	...
	_arg0 = (*C.GstPlaySubtitleInfo)(unsafe.Pointer(coreglib.InternObject(info).Native()))
...
func (info *PlayVideoInfo) Bitrate() int {
	...
	_arg0 = (*C.GstPlayVideoInfo)(unsafe.Pointer(coreglib.InternObject(info).Native()))
...
func (self *PlayVideoOverlayVideoRenderer) Expose() {
	...
	_arg0 = (*C.GstPlayVideoOverlayVideoRenderer)(unsafe.Pointer(coreglib.InternObject(self).Native()))
