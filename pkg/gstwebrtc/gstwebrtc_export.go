...
//export _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectClose
func _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectClose(arg0 C.gpointer, arg1 C.guintptr) {
	var f func()
	{
...
//export _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendData
func _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendData(arg0 C.gpointer, arg1 *C.GBytes, arg2 C.guintptr) {
	var f func(data *glib.Bytes)
	{
		closure := coreglib.ConnectedGeneratedClosure(uintptr(arg2))
		if closure == nil {
...
//export _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendString
func _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendString(arg0 C.gpointer, arg1 *C.gchar, arg2 C.guintptr) {
	var f func(data string)
	{
		closure := coreglib.ConnectedGeneratedClosure(uintptr(arg2))
		if closure == nil {
...
func _gotk4_gstwebrtc1_WebRTCICEClass_add_stream(arg0 *C.GstWebRTCICE, arg1 C.guint) (cret *C.GstWebRTCICEStream) {
	...
	if webRTCICEStream != nil {
		cret = (*C.GstWebRTCICEStream)(unsafe.Pointer(coreglib.InternObject(webRTCICEStream).Native()))
		C.g_object_ref(C.gpointer(coreglib.InternObject(webRTCICEStream).Native()))
	}
...
func _gotk4_gstwebrtc1_WebRTCICEClass_find_transport(arg0 *C.GstWebRTCICE, arg1 *C.GstWebRTCICEStream, arg2 C.GstWebRTCICEComponent) (cret *C.GstWebRTCICETransport) {
	...
	if webRTCICETransport != nil {
		cret = (*C.GstWebRTCICETransport)(unsafe.Pointer(coreglib.InternObject(webRTCICETransport).Native()))
		C.g_object_ref(C.gpointer(coreglib.InternObject(webRTCICETransport).Native()))
	}
...
//export _gotk4_gstwebrtc1_WebRTCICE_ConnectAddLocalIPAddress
func _gotk4_gstwebrtc1_WebRTCICE_ConnectAddLocalIPAddress(arg0 C.gpointer, arg1 *C.gchar, arg2 C.guintptr) (cret C.gboolean) {
	var f func(address string) (ok bool)
	{
		closure := coreglib.ConnectedGeneratedClosure(uintptr(arg2))
		if closure == nil {
			panic("given unknown closure user_data")
		...
		f = closure.Func.(func(address string) (ok bool))
	}
