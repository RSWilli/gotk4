...
// #cgo pkg-config: gstreamer-webrtc-1.0 gstreamer-analytics-1.0
...
// extern void _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendString(gpointer, gchar*, guintptr);
// extern void _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendData(gpointer, GBytes*, guintptr);
...
// extern void _gotk4_gstwebrtc1_WebRTCDataChannel_ConnectClose(gpointer, guintptr);
...
// extern gboolean _gotk4_gstwebrtc1_WebRTCICE_ConnectAddLocalIPAddress(gpointer, gchar*, guintptr);
...
func (channel *WebRTCDataChannel) ConnectClose(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(channel, "close", false, unsafe.Pointer(C._gotk4_gstwebrtc1_WebRTCDataChannel_ConnectClose), f)
}
...
func (channel *WebRTCDataChannel) ConnectSendData(f func(data *glib.Bytes)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(channel, "send-data", false, unsafe.Pointer(C._gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendData), f)
}

func (channel *WebRTCDataChannel) ConnectSendString(f func(data string)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(channel, "send-string", false, unsafe.Pointer(C._gotk4_gstwebrtc1_WebRTCDataChannel_ConnectSendString), f)
}
...
// ConnectAddLocalIPAddress: add a local IP address to use for ICE candidate
// gathering. If none are supplied, they will be discovered automatically.
// Calling this signal stops automatic ICE gathering.
func (ice *WebRTCICE) ConnectAddLocalIPAddress(f func(address string) (ok bool)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(ice, "add-local-ip-address", false, unsafe.Pointer(C._gotk4_gstwebrtc1_WebRTCICE_ConnectAddLocalIPAddress), f)
}
